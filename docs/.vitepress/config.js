  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        text: '🧪 Lab',
        items: [
          { text: 'Exp 01 — Login Form (Swing)',          link: '/lab/exp-01' },
          { text: 'Exp 02 — Progress Bar',                link: '/lab/exp-02' },
          { text: 'Exp 03 — Traffic Signal',              link: '/lab/exp-03' },
          { text: 'Exp 04 — Mouse Motion Adapter',        link: '/lab/exp-04' },
          { text: 'Exp 05 — JDBC Display Records',        link: '/lab/exp-05' },
          { text: 'Exp 06 — JDBC CRUD',                   link: '/lab/exp-06' },
          { text: 'Exp 07 — Simple Servlet',              link: '/lab/exp-07' },
          { text: 'Exp 08 — GET & POST Servlet',          link: '/lab/exp-08' },
          { text: 'Exp 09 — Session & Cookies',           link: '/lab/exp-09' },
          { text: 'Exp 10 — JSP Form',                    link: '/lab/exp-10' },
          { text: 'Exp 11 — JSP Scripting',               link: '/lab/exp-11' },
